  ...
  const [activeCategory, setActiveCategory] = useState('System Reference');
  ...
  const handlePlay = (youtubeId, title, artist) => {
  ...
  const handleAddSong = () => {
    if (generatedSong) {
      setSongs(prev => [generatedSong , ...prev]);
        ...
        <nav className="flex-1 overflow-y-auto py-6">
          <ul className="space-y-2 px-4">
            <li>
              ...
              >
                <Icons.Speaker size={18} className={activeCategory === 'System Reference' ? 'text-[#d4af37]' : ''} />
          ...
          <div className="px-4 mt-8 mb-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                {isGenerating ? <Icons.Loader2 size={14} className="animate-spin" /> : <Icons.Plus size={14} />}
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden bg-[#0f0f0f]">
        ...
        <header className="px-8 py-6 border-b border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0a0a0a]/80 backdrop-blur-md sticky top-0 z-10">
          ...
          <div className="relative w-full sm:w-72">
            <Icons.Search className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40" size={16} />
            <input
              type="text"
        ...
        <div className="flex-1 overflow-y-auto p-8">
          {filteredSongs.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-white/40">
              <Icons.Disc3 size={48} className="mb-4 opacity-20" />
              ...
              {filteredSongs.map((song) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-4 relative z-10 pr-6">
                    ...
                    >
                      <Icons.Play size={18} className="ml-1 group-hover/btn:scale-110 transition-transform" />
                    </button>
                  </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={generatedSong.category || 'Pop'} onChange={e => setGeneratedSong({...generatedSong, category: e.target.value })} className="w-full bg-[#1a1a1a] border border-white/10 rounded-lg py-2 px-3 text-sm text-white focus:outline-none focus:border-[#d4af37]/50">
